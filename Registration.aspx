...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="tbl form-card">
    <tr>
        <td class="tblhead" colspan="2">
            Registration Form</td>
    </tr>
    <tr>
        <td colspan="2" class="form-subhead">
            Create your account to track orders, save favorites, and check out faster.
        </td>
    </tr>
    <tr>
        <td class="lbl">
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="txtname" runat="server" CssClass="txt form-input"></asp:TextBox>
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="txtsname" runat="server" CssClass="txt form-input"></asp:TextBox>
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="txtadd" runat="server" CssClass="txt form-input" 
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="txtcity" runat="server" CssClass="txt form-input"></asp:TextBox>
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="txtppin" runat="server" CssClass="txt form-input"></asp:TextBox>
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="txtmo" runat="server" CssClass="txt form-input" 
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="txtemail" runat="server" CssClass="txt form-input"></asp:TextBox>
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="txtpass" runat="server" CssClass="txt form-input" 
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="txtcpass" runat="server" CssClass="txt form-input" 
                TextMode="Password"></asp:TextBox>
    ...
    <tr>
        <td colspan="2" align="center" style="color: #272727">
